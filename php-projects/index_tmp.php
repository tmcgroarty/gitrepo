            ...
            <?php else: ?>
                <?php foreach ($items as $row): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="name" form="<?= h($fid) ?>" value="<?= h($row['name']) ?>" required>
                        </td>

                        <td>
                            <select name="category_id" form="<?= h($fid) ?>">
                                <option value="">— None —</option>
                                <?php foreach ($categories as $c): ?>
                                    <option value="<?= h($c['id']) ?>"
                        ...
                        <td>
                            <select name="location_id" form="<?= h($fid) ?>">
                                <option value="">— None —</option>
                                <?php foreach ($locations as $l): ?>
                                    <option value="<?= h($l['id']) ?>"
                        ...
                        <td>
                            <input type="number" name="quantity" form="<?= h($fid) ?>" min="0" value="<?= h($row['quantity']) ?>">
                        </td>

                        <td>
                            <input type="text" name="condition" form="<?= h($fid) ?>" value="<?= h($row['condition'] ?? '') ?>">
                        </td>

                        <td>
                            <input type="number" name="estimated_value" form="<?= h($fid) ?>" step="0.01" min="0"
                                   value="<?= h($row['estimated_value'] ?? '') ?>">
                        </td>

                        <td>
                            <input type="number" name="sold_price" form="<?= h($fid) ?>" step="0.01" min="0"
                        ...
                        <td>
                            <input type="number" name="shipping_cost" form="<?= h($fid) ?>"
                                   step="0.01" min="0"
                        ...
                        <td>
                            <form id="<?= h($fid) ?>" method="POST" style="margin:0;">
